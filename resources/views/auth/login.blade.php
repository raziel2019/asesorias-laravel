                ...
                <div class="card bg-secondary shadow border-0" >
                    ...
                    <div class="card-body px-lg-5 py-lg-5 mt-4">
                        <div class="text-center text-muted mb-4 mt-1">
                            <small style="font-size:17px"> <strong>¡Hola bienvenido!</strong></small>
                            <br>
                            <small style="font-size:13px">Inicia sesión para comenzar</small>
                        </div>
                        <form role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary btn-block my-4" style="font-size:16px">{{ __('Acceder') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
