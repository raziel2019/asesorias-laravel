            ...
            <div class="card-header border-0">
                <div class="row align-items-center">
                    ...
                    <div class="card-body mt--4">
                        <form class='form-row' action="{{ route('AsesoriaEstudiante.update',$AsesoriaEstudiante->id ) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                        ...
                        @endif
                            ...
                            <div class="form-group{{ $errors->has('nombre') ? ' has-danger' : '' }} col-md-12">
                                ...
                                <input type="text" name="Descripcion" id="input-status" class="form-control form-control-alternative{{ $errors->has('status') ? ' is-invalid' : '' }}" placeholder="{{ __('Descripcion') }}" value="{{$AsesoriaEstudiante->Descripcion}}" required>
                            ...
                            <div class="form-group{{ $errors->has('nombre') ? ' has-danger' : '' }} col-md-12">
                                ...
                                <input type="text" name="FechaAsesoria" id="input-status" class="form-control form-control-alternative{{ $errors->has('status') ? ' is-invalid' : '' }}" placeholder="{{ __('FechaAsesoria') }}" value="{{$AsesoriaEstudiante->FechaAsesoria}}" required>
